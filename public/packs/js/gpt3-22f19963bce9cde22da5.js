...
var currentDialogue = null; // Stores the current conversation. Messages[]
var promptsCount = 0; // How many prompts have been sent so far?
...
function createChatBubble(content, sender) {
  ...
  chatBubble.className = sender === "user" ? "chat-bubble-user" : "chat-bubble-cheko";
...
var generateText = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(prompt) {
    var chekoLoadingBubble, setLoading, scrollContainer, chatContainer, response, json, chekoResponse;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          setLoading = function _setLoading(bool) {
            if (bool) {
          ...
          // Utils:
          chekoLoadingBubble = document.getElementById("cheko-loading-bubble");
          ...
          // Scroll into view
          scrollContainer = document.getElementsByClassName("card-body-top")[0];
          setTimeout(function () {
            scrollContainer.scrollTop = scrollContainer.scrollHeight;
          }, 50);

          // 2. Add prompt as a chat bubble:
          chatContainer = document.getElementById("gpt-chat-container");
          chatContainer.appendChild(createChatBubble(prompt, "user"));

          // 3. Send Prompt to Controller:
          _context.prev = 10;
          _context.next = 13;
          return fetch("/gpt3/generate", {
            method: "POST",
            headers: {
        ...
        case 23:
          json = _context.sent;
          // -- Event Log --
          window.LOG_EVENTS.logSubmitPrompt(json.usage.prompt_tokens, json.usage.completion_tokens, json.usage.total_tokens, json.usage.model);
          ...
          chekoResponse = json.generated_text.split("\n").map(function (t) {
            return "<p>".concat(t, "</p>");
          }).join("");
          ...
          _context.next = 37;
          return fetch("/gpt3/render_better_answer_bubble").then(function (response) {
...
var promptArea = document.querySelector("textarea#prompt");
...
/******/ });
//# sourceMappingURL=gpt3-22f19963bce9cde22da5.js.map