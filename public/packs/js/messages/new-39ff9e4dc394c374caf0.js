...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/messages/new.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/messages/new.js":
/*!**********************************************!*\
  !*** ./app/javascript/packs/messages/new.js ***!
  \**********************************************/
...
/* WEBPACK VAR INJECTION */(function($) {// $( '#new_message' ).on('submit', function(){
//   // $( '#new_message' )[0].reset()
//   this.reset();
// })
...
$('#new_message').on("submit", function (event) {
  ...
  if ($("#type").val() == "user") {
    ...
    $.ajax({
      type: "POST",
      url: "/tutors/qnas/" + qnaId + "/messages?chat_id=" + chatId,
...
/******/ });
//# sourceMappingURL=new-39ff9e4dc394c374caf0.js.map